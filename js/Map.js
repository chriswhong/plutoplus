class MapComponent extends React.Component {
  ...
  initializeMap() {
    ...
    fetch('./data/viz.json').then(d => d.json()).then(vizJson => {
      cartodb.createLayer(map, vizJson).addTo(map).on('done', layer => {
  ...
  highlightNta(e, latlng, pos, data) {
    ...
    sql.execute(query, {}, {
      ...
      this.selectLayer.addData(d); // setup SQL statement for intersection
